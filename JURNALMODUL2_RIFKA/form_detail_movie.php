                    ...
                    <div class="card shadow-sm p-3">
                        <div class="card-body">
                            <div class="form-floating mb-3">
                                ...
                                <input type="text" class="form-control" id="title" value="<?= htmlspecialchars($movies["judul"]) ?>" disabled>
                            ...
                            <div class="form-floating mb-3">
                                ...
                                <input type="text" class="form-control" id="genre" value="<?= htmlspecialchars($movies["genre"]) ?>" disabled>
                            ...
                            <div class="form-floating mb-3">
                                ...
                                <input type="text" class="form-control" id="director" value="<?= htmlspecialchars($movies["sutradara"]) ?>" disabled>
                            ...
                            <div class="form-floating mb-3">
                                ...
                                <input type="text" class="form-control" id="release_year" value="<?= htmlspecialchars($movies["tahun"]) ?>" disabled>
