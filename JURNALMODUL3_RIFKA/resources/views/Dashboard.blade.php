            ...
            <div class="dashboard-left">
                <div class="logo-wrapper">
                    ...
                    <div class="logo-center">
                        ...
                        <img src="{{ assets('images/logo-EAD.png') }}" alt="Logo EAD">
                    </div>
                </div>
            </div>
            ...
            <div class="dashboard-right">
                <div class="greeting-box">
                    <h1 class="greeting-title">
                        ...
                        {{ $salam }}, <span class="text-primary"> {{  $mahasiswa->nama }}<!-- 5. Panggil variabel dari controller untuk menampilkan nama--></span>
                ...
                <div class="info-grid">
                    <div class="info-card fade-in delay-1">
                        ...
                        <div class="info-text">
                            ...
                            <h4 class="fw-semibold"> {{ $accessTime }} WIB <!-- 6. Panggil variabel dari controller untuk menampilkan waktu akses--></h4>
                        </div>
                    </div>
                    ...
                    <div class="info-card fade-in delay-2">
                        ...
                        <div class="info-text">
                            ...
                            <h4 class="fw-semibold"> {{ $accessTime }} WIB <!-- 7. Panggil variabel dari controller untuk menampilkan waktu akses--></h4>
                        </div>
                    </div>
                </div>
            </div>
