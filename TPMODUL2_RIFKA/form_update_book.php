...
$query = "SELECT books.id, books.title, books.category_id, categories.category_name, books.author, books.stock
          FROM books
        ...
        <div class="card shadow p-4">
            ...
            <form action="update.php" method="POST">
                ...
                <div class="form-floating mb-3">
                    ...
                    <input type="number" class="form-control" name="stock" value="<?= htmlspecialchars($book['stock']) ?>" min="0" required>
                    <label>Stok</label>
                </div>
